  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Fixed width constraints to prevent collapsing
          "bg-background",
          ...
          // Width constraints - CRITICAL: prevents collapsing
          "w-[90%] min-w-[400px] max-w-lg",
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-lg leading-none font-semibold whitespace-nowrap", className)}
      {...props}
    />
  )
}
