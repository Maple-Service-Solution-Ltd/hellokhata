...
import { Phone, Lock, ArrowRight, Loader2, Store, Sparkles, CheckCircle2, User, Building2, ArrowLeft, UserPlus, Search, ChevronDown } from 'lucide-react';
...
export function LoginPage({ onSuccess }: LoginPageProps) {
  ...
  const handleResendOTP = () =>{
    const obj = {userId,purpose: !isRegisterMode ? 'signin': 'signup'};
 ...
 registerUser.mutate(user,{
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-6 lg:p-8 relative overflow-hidden">
      {/* Premium Background - Same as main app */}
      <div className="fixed inset-0 pointer-events-none" style={{ backgroundColor: '#0F141B' }}>
        {/* Subtle top-left indigo glow */}
        <div 
          className="absolute top-0 left-0 w-[600px] h-[500px] opacity-30"
          style={{
            background: 'radial-gradient(ellipse 80% 60% at 5% 0%, rgba(79, 91, 255, 0.15) 0%, transparent 60%)'
          }}
        />
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse 60% 50% at 90% 90%, rgba(20, 35, 55, 0.4) 0%, transparent 60%)'
          }}
        />
        {/* Center ambient glow */}
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse 50% 40% at 50% 50%, rgba(15, 191, 159, 0.08) 0%, transparent 70%)'
          }}
        />
      </div>

      {/* Responsive container: Mobile -> Tablet -> Desktop -> Large Desktop */}
      <motion.div
      ...
      >
        ...
        {/* Login Card - Premium styling with responsive width */}
        <div 
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 'phone' && !isRegisterMode && (
              ...
              >
                <div className="shrink-0">
                  <h2 className="text-xl md:text-2xl font-semibold whitespace-nowrap" style={{ color: '#E6EDF5' }}>
                    Welcome Back!
                  </h2>
                  <p className="text-sm md:text-base whitespace-nowrap mt-1" style={{ color: '#9DA7B3' }}>
                    Enter your phone number to login
                  </p>
                </div>

                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium whitespace-nowrap shrink-0" style={{ color: '#E6EDF5' }}>
                    Phone Number
                  </label>
                  ...
                  <p className="text-xs md:text-sm whitespace-nowrap shrink-0" style={{ color: '#6B7684' }}>
                ...
                <Button
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #4F5BFF 0%, #5E6AFF 100%)',
                    color: '#FFFFFF',
                ...
                <div className="relative my-2 shrink-0">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.05)' }}></div>
                  </div>
                  <div className="relative flex justify-center text-xs md:text-sm">
                    <span className="px-3 whitespace-nowrap" style={{ color: '#6B7684', background: 'linear-gradient(180deg, rgba(35, 46, 60, 1) 0%, rgba(28, 36, 48, 1) 100%)' }}>or</span>
                  </div>
                </div>
            ...
            {step === 'phone' && isRegisterMode && (
              ...
              >
                <div className="shrink-0">
                  ...
                  <p className="text-sm md:text-base whitespace-nowrap mt-1 ml-10" style={{ color: '#9DA7B3' }}>
                ...
                {/* Business Type - Searchable Select Dropdown */}
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium whitespace-nowrap shrink-0" style={{ color: '#E6EDF5' }}>
                    Business Type
                  </label>
                  <div className="relative w-full">
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: '#171F29',
                        borderColor: showBusinessTypeDropdown ? '#4F5BFF' : 'rgba(255, 255, 255, 0.05)',
                        color: '#E6EDF5'
                      }}
                    >
                      <span className="flex items-center gap-3">
                        ...
                        {selectedBusinessType && (
                          <span className="text-xs px-2 py-0.5 rounded-full" style={{ backgroundColor: 'rgba(79, 91, 255, 0.15)', color: '#9DA7B3' }}>
                          ...
                          {filteredBusinessTypes.length > 0 ? (
                            filteredBusinessTypes.map((type) => (
                              <button
                                ...
                                style={{
                                  backgroundColor: businessType === type.value ? 'rgba(79, 91, 255, 0.1)' : 'transparent'
                                }}
                              >
                                <div>
                                  <span className="text-sm font-medium" style={{ color: businessType === type.value ? '#4F5BFF' : '#E6EDF5' }}>
                                    {type.label}
                                  </span>
                                ...
                                {businessType === type.value && (
                                  <CheckCircle2 className="h-4 w-4 shrink-0" style={{ color: '#4F5BFF' }} />
                                )}
                              </button>
                            ))
                          ) : (
                            <div className="px-4 py-3 text-sm text-center" style={{ color: '#6B7684' }}>
                ...
                <Button
                  ...
                  disabled={registerUser.isPending || phone.length !== 11 || !name || !businessName}
                  className="w-full shrink-0 h-12 md:h-14 font-medium text-base"
                  style={{
                    background: 'linear-gradient(135deg, #0FBF9F 0%, #1FAF86 100%)',
                    color: '#FFFFFF',
            ...
            {step === 'otp' && (
              ...
              >
                <div className="shrink-0">
                  <h2 className="text-xl md:text-2xl font-semibold whitespace-nowrap" style={{ color: '#E6EDF5' }}>
                    {isRegisterMode ? 'Verify & Complete Registration' : 'Verify OTP'}
                  </h2>
                  <p className="text-sm md:text-base whitespace-nowrap mt-1" style={{ color: '#9DA7B3' }}>
                  ...
                  {verifyOTP.isPending ? (
                    ...
                    <>
                      <span className="whitespace-nowrap">
                        {isRegisterMode ? 'Verify & Complete' : 'Verify OTP'}
                      </span>
